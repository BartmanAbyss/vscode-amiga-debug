...
import { FindRef, FindCallback, Find } from './find';
...
export const ObjdumpView: FunctionComponent<{
	...
	const findCallback = useCallback((args: FindCallback) => {
		if(args.action === 'prev') {
			...
			setFind({ text: args.text ?? '', internal: true });
