...
suite("MI Parse", function () {
	test("Simple out of band record", function () {
	...
	test("Console stream output with new line", function () {
	...
	test("Simple result record", function () {
	...
	test("Advanced out of band record (Breakpoint hit)", function () {
	...
	test("Advanced result record", function () {
	...
	test("Result record with empty list", function () {
	...
	test("valueof children", function () {
		let obj = [
			[
				"frame",
				[
