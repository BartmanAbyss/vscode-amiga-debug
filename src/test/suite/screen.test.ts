...
suite("screen", function () {
	test("profile", profile('screen', function () {
		const PROFILES = JSON.parse(fs.readFileSync(path.join(testDataDir, 'profile/desertdream-dots.uss-2022.09.12-14.21.41.amigaprofile')).toString()) as ICpuProfileRaw[];
