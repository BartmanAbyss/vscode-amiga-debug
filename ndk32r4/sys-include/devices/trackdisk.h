...
/*
**	$VER: trackdisk.h 47.3 (24.8.2020)
**
...
#define	TDERR_BadSecPreamble	22	/* out of bounds sector number/offset */
#define	TDERR_BadSecID		23	/* incorrect sector type */
...
#define	TDERR_BadSecHdr		27	/* incorrect sector track number */
