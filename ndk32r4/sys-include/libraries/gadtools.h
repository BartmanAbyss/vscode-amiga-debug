...
/*
**	$VER: gadtools.h 47.6 (24.12.2021)
**
**	gadtools.library definitions for data structures, types,
**	control flags and Tag values
**
...
struct NewGadget
{
    ...
    CONST_STRPTR ng_GadgetText;		/* gadget label */
...
#define GTLV_ShowSelected    (GT_TagBase+53)/* show selected entry beneath
					     * listview, set tag data = NULL for display-only,
					     * or pointer to a string gadget you've created
					     */
